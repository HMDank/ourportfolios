...
def performance_cards(
    ...
    """Create performance cards with dynamic charts - exactly like your original but as a component"""
    return rx.vstack(
        rx.hstack(
            rx.foreach(
                categories[:3],
                lambda category: create_dynamic_chart(
                    category,
                    metrics_by_category,
                    selected_metrics,
                    chart_data_by_category,
            ...
            rx.cond(
                ...
                rx.vstack(
                    rx.cond(
                        categories.length() == 0,
                        rx.hstack(
                            create_placeholder_chart("Chart 1", None, 280),
                            create_placeholder_chart("Chart 2", None, 280),
                            create_placeholder_chart("Chart 3", None, 280),
                            spacing="4",
                            width="100%",
                            align="stretch",
                            justify="between",
            ...
            rx.cond(
                ...
                rx.vstack(
                    rx.cond(
                        categories.length() <= 3,
                        rx.hstack(
                            create_placeholder_chart("Chart 4", None, 280),
                            create_placeholder_chart("Chart 5", None, 280),
                            create_placeholder_chart("Chart 6", None, 280),
                            spacing="4",
                            width="100%",
                            align="stretch",
                            justify="between",
